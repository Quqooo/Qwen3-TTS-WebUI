"""
QwenLM/Qwen3-TTS 与 dffdeeq/Qwen3-TTS-streaming 分支桥接模块

两个分支使用相同的 Qwen3-TTS 模型架构，共享同一套推理实现。
"""
import asyncio
import base64
import logging
...
class StreamingBranch(TTSBranch):
    """QwenLM/Qwen3-TTS / dffdeeq/Qwen3-TTS-streaming 分支实现（子进程 Worker 模式）
